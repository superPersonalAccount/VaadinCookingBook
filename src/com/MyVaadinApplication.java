...
public class MyVaadinApplication extends UI{
    ...
    public void life(){
        ...
        controllerLogin.loginButtonInLogin.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent clickEvent) {
                ...
                if(controllerLogin.loginField.getValue().isEmpty() || controllerLogin.passwordField.getValue().isEmpty()){
                    ...
                    controllerLogin.loginField.setInputPrompt("adres e-mail");
                    controllerLogin.loginField.setValue("");
                    controllerLogin.passwordField.setInputPrompt("adres e-mail");
                    controllerLogin.passwordField.setValue("");
        ...
        controllerRegister.registerButtonInRegister.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent clickEvent) {
                ...
                if(controllerRegister.getLoginFieldRegister().isEmpty() || controllerRegister.passwordFieldRegister.isEmpty() || controllerRegister.repeatPasswordFieldRegister.isEmpty() || controllerRegister.emailFieldRegister.isEmpty()){
                    ...
                    controllerRegister.getEmailFieldRegister().setInputPrompt("adres e-mail");
                    controllerRegister.getEmailFieldRegister().setValue("");
                    controllerRegister.getLoginFieldRegister().setInputPrompt("login");
                    controllerRegister.getLoginFieldRegister().setValue("");
                    controllerRegister.getPasswordFieldRegister().setInputPrompt("wprowadź hasło");
                    controllerRegister.getPasswordFieldRegister().setValue("");
                    controllerRegister.getRepeatPasswordFieldRegister().setInputPrompt("wprowadź ponownie hasło");
                    controllerRegister.getRepeatPasswordFieldRegister().setValue("");
        ...
        controllerRegister.backButtonRegister.addClickListener(new Button.ClickListener() {
            @Override
            public void buttonClick(Button.ClickEvent clickEvent) {
                layout.removeAllComponents();
                layout.addComponent(controller);
        ...
        controllerLogin.backButtonLogin.addClickListener(new Button.ClickListener() {
            @Override
            public void buttonClick(Button.ClickEvent clickEvent) {
                layout.removeAllComponents();
                layout.addComponent(controller);
